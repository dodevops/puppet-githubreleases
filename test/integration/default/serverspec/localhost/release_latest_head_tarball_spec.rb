...
describe file('/tmp/release.0.0.2.head.tar.gz') do
  it { should exist }
  it { should be_file }
  its(:md5sum) { should eq 'c76c61814a4845e16ad200cd0dbb0492' }
end
...
describe file('/tmp/release.0.0.2.head.zip') do
  it { should exist }
  it { should be_file }
  its(:md5sum) { should eq 'ca899e062eed1c0c5e8ee5ad732a5303' }
end
...
describe file('/tmp/release.0.0.2.asset.debian') do
  it { should exist }
  it { should be_file }
  its(:md5sum) { should eq '5765d145e422318c0d25e19e6ec82be0' }
end
...
describe file('/tmp/release.0.0.2.asset.exe') do
  it { should exist }
  it { should be_file }
  its(:md5sum) { should eq '53b76eb603eebb7572172a89248ac3fe' }
end
